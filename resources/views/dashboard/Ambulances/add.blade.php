<div class="modal fade" id="add">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content modal-content-demo ">
            ...
            <form action="{{route('Ambulance.store')}}" method="post" class="form">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="car_number" class="form-control" id="ambulance_number" required>
                        </div>
                        <div class="col-md-6">
                            <label for="ambulance_model" class="form-label">{{trans('Ambulance.ambulance_model')}}</label>
                            <input type="text" name="car_model" class="form-control" id="ambulance_model" required>
                        </div>

                        <div class="col-md-6">
                            <label for="car_year_manufactured" class="form-label">{{trans('Ambulance.yrear_of_manufacture')}}</label>
                            <input type="text" name="car_year_manufactured" class="form-control" id="car_year_manufactured" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select name="ambulance_type" class="form-control" id="ambulance_type" required>
                                <option value="owned">{{trans('Ambulance.owned')}}</option>
                                <option value="rinted">{{trans('Ambulance.rinted')}}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="driver_license_number" class="form-control" id="license_driving_number" required>
                        </div>

                        <div class="col-md-6">
                            <label for="phone_number" class="form-label">{{trans('Ambulance.phone_number')}}</label>
                            <input type="phone" name="driver_phone" class="form-control" id="phone_number" required>
                        </div>
                        <div class="col-md-6">

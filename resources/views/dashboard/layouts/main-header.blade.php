		...
		<div class="main-header-left ">
			<div class="responsive-logo">
				...
				<a href="{{ url('/' . $page = 'index') }}"><img
						src="{{URL::asset('dashboard/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo"></a>
						...
						<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
							...
							@if (App::getLocale() == 'ar')
								<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
										src="{{URL::asset('Dashboard/img/flags/morocco_flag.png')}}" alt="img"></span>
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					...
					<div class="dropdown-menu">
						...
						@endif
								@csrf
								<button class="btn dropdown-item" type="submite"><i class="bx bx-log-out"></i> Sign Out
								</button>
							</form>
					</div>
				</div>

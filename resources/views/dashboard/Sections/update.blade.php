    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{trans('dashboard/sections_trans.update')}} {{$section->name}}</h6><button aria-label="Close" class="close btn"
            ...
            <form action="{{route('Sections.update',$section->id)}}" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="exemple" autocomplete="off" name="name" value="{{$section->name}}">
                    </div>
                </div>
